...
// //////////////////////////////////////////
// Modified bamazonCustomer.js file for LEVEL 3

// Named bamazonCustomer3.js for Supervisor Level
// THIS IS IN PROGRESS////////////////////////////
// /////////////////////////////////////////////
...
function start() {
    ...
    connection.query("SELECT * FROM products", function (err, res) {
        ...
        // instantiate
        var table = new Table({
            head: ['ID', 'Product Name', 'Department', 'Price', 'Quantity', 'Product Sales']
            // , colWidths: [100, 200]
        });
...
// write function if else statment for the 'Product Sales' to equal = the  
// number of products removed from the inventory multiplied by
// cost of one individual product.
